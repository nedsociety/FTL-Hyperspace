...
set(CMAKE_C_COMPILER "/usr/bin/clang-12" CACHE PATH "")
set(CMAKE_CXX_COMPILER "/usr/bin/clang++-12" CACHE PATH "")
# Note on -fPIC:
...
string(APPEND CMAKE_C_FLAGS " --gcc-toolchain=/usr/gcc-4.8-clang-toolchain/ -D_GLIBCXX_USE_CXX11_ABI=0 -m32 -fPIC")
string(APPEND CMAKE_CXX_FLAGS " --gcc-toolchain=/usr/gcc-4.8-clang-toolchain/ -D_GLIBCXX_USE_CXX11_ABI=0 -m32 -fPIC")
